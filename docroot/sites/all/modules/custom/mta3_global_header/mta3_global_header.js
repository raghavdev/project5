...
var sourceURL = 'http://new2dev.mta.info'; 
=======
var request = createCORSRequest("get", "/sites/all/modules/custom/mta3_global_header/raw_header.php");
...
if (request){
	...
	function launch(){
<<<<<<< HEAD
		jQuery.get("http://new2dev.mta.info/sites/all/modules/custom/mta3_global_header/raw_header.php", function(response){
