...
<!--My Trip start 1-->
    ...
    #mytrip label { margin: 0 5px 0 0 !important; }
    #mytrip table { border: none; margin: 0; width: 100%; }
    #mytrip table tbody { border: none; }
    #mytrip table tbody tr { border: none; }
    #mytrip table tr td { vertical-align: top; padding: 0 0 5px !important; }
    #mytrip input { margin-right: 0px;}
    #mytrip select { margin-right: 3px;}
...
<img src="/sites/all/themes/mta/images/loading.gif" id="tpimageForWait"
    ...
    <div>
      <table style="width: 100%; margin: 0; vertical-align: top; border: none;" border="0">
        <tr>
        ...
        <tr>
          ...
          <td style="padding-left: 5px !important;"><div>
            ...
            <div>
              ...
              <img alt="calendar" onclick="document.forms['tpForm'].elements['date'].focus()" src="/sites/all/themes/mtadaptive/images/calendar-icon.jpg" style="margin-left: 6px; display: none;" /></div></td>
        </tr>
      </table>
      <div id="divTransitMode" style="display: block; padding: 0 0 5px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;">
        <div>
          <label>Using</label>
        </div>
        <div>
