...
<div id="<?php print $block_html_id; ?>" class="roundCorners featurebox">
    ...
    <span id="statusDateTime"><?php echo "as of ". date("h:i:s a"); ?></span>
    ...
    <ul>
        ...
        <li class="t tdiv notselectedStatusTab" id="lirrTab">LIRR</li>
        <li class="t tdiv notselectedStatusTab" id="mnrTab">MNR</li>
    ...
    <div class="content"<?php print $content_attributes; ?> style="clear:both;">
        ...
        <div id="subwayDiv" style="float: left; margin-top: 1px;">
            ...
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999; padding: 1px 0;">
        ...
        <!-- LIRR Rail Div -->
        <div id="lirrDiv" style="float: left; display: none;">
            ...
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
        ...
        <!-- End of LIRR Rail -->
        <div id="mnrDiv" style="float: left; display: none;">
            <!--<div class="statusrow" style="float: left; width: 100%;"><span class="RailRoadCompany">Metro-North Railroad</span>-->
                <!--<ul style="float: right; padding:0; margin:0">
            ...
            <div class="statusrow" style="float: left;">
            ...
            <div class="statusrow substation" style="float: left;">
                <div class="railLineStatus"></div>
                <div style="margin-left: 10px;" class="span-11 railLineItem">Wassaic</div>
            ...
            <div class="statusrow substation" style="float: left;">
                <div class="railLineStatus"></div>
                <div style="margin-left: 10px;" class="span-11 railLineItem">New Canaan</div>
                <div id="NewCanaan" class="railStation railCategory"></div>
            </div>
            <div class="statusrow substation" style="float: left;">
                <div class="railLineStatus"></div>
                <div style="margin-left: 10px;" class="span-11 railLineItem">Danbury</div>
                <div id="Danbury" class="railStation railCategory"></div>
            </div>
            <div class="statusrow substation" style="float: left;">
                <div class="railLineStatus"></div>
                <div style="margin-left: 10px;" class="span-11 railLineItem">Waterbury</div>
        ...
        <div id="busDiv" style="float: left; display: none; margin-top: 11px;">
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                    <span class="span-11 busLineItem">B1 - B84</span><span id="B1-B84" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">B100 - B103</span><span id="B100-B103" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">BM1 - BM5</span><span id="BM1-BM5" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">BX1 - BX55</span><span id="BX1-BX55" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">BXM1 - BXM18</span><span id="BXM1-BXM18" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">M1 - M116</span><span id="M1-M116" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Q1 - Q113</span><span id="Q1-Q113" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">QM1 - QM25</span><span id="QM1-QM25" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">S40 - S98</span><span id="S40-S98" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">x1 - x68</span><span id="x1-x68" class="busCategory"></span>
            </div>
        </div>
        <!-- End of Bus -->
        ...
        <div id="bntDiv" style="float: left; display: none; margin-top: 12px;">
            ...
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Throgs Neck</span><span id="ThrogsNeck" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Henry Hudson</span><span id="HenryHudson" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Marine Parkway</span><span id="MarineParkway" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Bronx-Whitestone</span><span id="Bronx-Whitestone" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Hugh L. Carey</span><span id="HughLCarey" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Queens Midtown</span><span id="QueensMidtown" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Robert F. Kennedy</span><span id="RobertFKennedy" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Cross Bay</span><span id="CrossBay" class="busCategory"></span>
            </div>
            <div class="statusrow" style="float: left; border-bottom: 1px dotted #999999;">
                <span class="span-11 busLineItem">Verrazano-Narrows</span><span id="Verrazano-Narrows" class="busCategory"></span>
            </div>
        </div>
